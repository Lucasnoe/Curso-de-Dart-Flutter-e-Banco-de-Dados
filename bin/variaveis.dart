...
void main(List<String> arguments) {
  ...
  String le_nome = stdin.readLineSync() // Método std.readLineSync:  lê uma lihha do terminal e converte pra String
  
  String leidade = stdin.readLineSync()!;
  int idade =int.parse(leidade); // Método int.parse: converte uma variável em int
  double salario = 1800.55;
  print(
      'Hello world: $le_nome e minha idade é: $idade, bem como meu salario é: $salario');
}
